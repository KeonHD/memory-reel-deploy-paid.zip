...
//
// How it works:
// 1. Client connects the user's wallet in-browser, sends the USDC transfer,
//    and gets the resulting tx hash back automatically (no manual copy-paste
//    needed on the frontend — see index.html for that flow).
